...
export default class SimilarMovies extends Component {
    ...
    _onendreached = () => {
        if (this.state.page <= this.state.total_pages)
            ...
            fetch("https://api.themoviedb.org/3/movie/" + this.props.navigation.getParam('id', 0) + "/similar?api_key=e9854cd26bab97bcdd2a7657868112fd&language=en-US&page=" + (this.state.page + 1)).
