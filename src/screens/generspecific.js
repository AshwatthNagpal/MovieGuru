...
export default class GenerSpecific extends Component {
    ...
    myfetch() {
        FETCH.getMoviesForGener(1, this.props.navigation.getParam('id', 0))
            .then(d => {
    ...
    _onendreached = () => {
        if (this.state.page <= this.state.total_pages) {
            ...
            FETCH.getMoviesForGener(this.state.page + 1, this.props.navigation.getParam('id', 0))
                .then(d => {
                    ...
                    return (
                        <View style={sheet.view}>
                            ...
                            <View justifyContent={'center'}>
                                <Text style={sheet.text}>{item.original_title} ({item.release_date.substring(0, 4)})</Text>
